...
import sk from "../../../public/projectimg.png"
...
const Dashboardpage = () => {
  ...
  const handleDelete = (id: number | string) => {
    console.log(id,searchValue,sort)
} 
        ...
        <li className="shadow-xl lg:px-6 md:px-2 py-8 px-8 rounded-md">
          <span className="flex justify-between lg:items-center items-start">
            ...
            <span className="flex flex-col gap-2">
              ...
              <span className="lg:text-3xl text-2xl font-semibold">{20}</span>
            </span>
          </span>
        </li>
        <li className="shadow-xl lg:px-6 md:px-2 py-8 px-8 rounded-md">
          <span className="flex justify-between lg:items-center items-start">
            ...
            <span className="flex flex-col gap-2 text-right">
              ...
              <span className="lg:text-3xl text-2xl font-semibold"><Link href="/drashboard/addproject">Add</Link></span>
            </span>
          </span>
        </li>
        ...
        <div className="overflow-x-auto mt-10">
          <ul className="bg-white shadow-md rounded-lg overflow-hidden">
            ...
            {projectArray.map((project, index) => (
             ...
             <Image src={project.img} className="md:rounded-full object-cover md:w-[50px] md:h-[50px]" alt="img" width={400} height={400} />
             ...
             <div className="flex items-center justify-center">
               <span className="bg-blue-400 text-white text-center py-1 rounded-md px-4 md:w-auto w-full">
                 <Link href={`/drashboard/updateproject/${project.id}`}>Update</Link>
               </span>
             </div>
